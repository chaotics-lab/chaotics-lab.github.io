...
import { Sparkles, Code, Zap, Brain, Cpu, Rocket, ChevronDown } from 'lucide-react';
              ...
              >
                <div className="flex flex-col md:flex-row items-center md:items-start gap-6 relative">
                    ...
                    <blockquote className="text-space-secondary text-xl italic border-l-4 border-gray-300 pl-4 flex-grow">
                      ...
                      Once I master a tool or concept, I use AI responsibly to speed up work without losing control of my critical mind (<a href="https://www.media.mit.edu/projects/your-brain-on-chatgpt/overview/" className="underline">Your Brain on ChatGPT</a>).
                    </blockquote>
                    <ChevronDown 
